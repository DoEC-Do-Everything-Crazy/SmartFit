...
const ProductDetailScreen = ({props, route}) => {
  ...
  const handleOnRate = () => {
    ...
    navigation.navigate(routes.RATE_SCREEN, {
      item: {name: product.name, productId: product._id},
    });
  };
    ...
    <>
      {product && (
        <SafeAreaView
          ...
          <Block backgroundColor={theme.colors.backgroundSetting} flex>
            <Header canGoBack cart title={t('productDetail')} />
                ...
                <Block paddingBottom={50} flex>
                  <Block
                    ...
                    <Block row marginTop={10}>
                      ...
                      />
                      <Text>({product.totalReviews})</Text>
                    </Block>
                  </Block>
                  <Block
                    row
