  ...
  return (
    <Svg
      ...
      <Path
        ...
        fill={color}
      />
      <Circle cx={3.5} cy={5.5} r={1.25} stroke={color} strokeWidth={2.5} />
      <Circle cx={3.5} cy={12} r={1.25} stroke={color} strokeWidth={2.5} />
      <Circle cx={3.5} cy={18.5} r={1.25} stroke={color} strokeWidth={2.5} />
    </Svg>
  );
};
